...
public class UserArtisan implements Comparable<UserArtisan>
{
    ...
    public UserArtisan(String username, String email, String phoneNumber, String city, String skills, String imgUr, float rating, int low_rating, int high_rating) {
    ...
    @Override
    public int compareTo(UserArtisan other) {
